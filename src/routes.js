...
const pages = {
  ...
  authentication: {
    ...
    verify: lazy(() => import('views/pages/authentication/VerifyEmail')),
  ...
  miscellaneous: {
    ...
    referrals: lazy(() => import('views/pages/miscellaneous/Referrals')),
...
const routesAndMenuItems = {
  mainMenuItems: [
    ...
    },
    {
      ...
      component: Rooms,
      label: 'Rooms',
      icon: <MdRoom size={30} color="white" />,
      subs: [
        { path: '/room-types', label: 'Room Types', component: RoomTypes },
        { path: '/rooms', label: 'Rooms List', component: Rooms },
        // { path: '/analytic', label: 'menu.analytic', component: dashboards.analytic },
      ],
    },
    // {
    //   path: `${appRoot}/room-types`,
    //   component: KitchenBarCategories,
    //   label: 'Room Types',
    //   icon: <IoHomeSharp size={30} color="white" />,
    //   // subs: [
    //   //   { path: '/default', label: 'menu.default', component: dashboards.default },
    //   //   { path: '/visual', label: 'menu.visual', component: dashboards.visual },
    //   //   { path: '/analytic', label: 'menu.analytic', component: dashboards.analytic },
    ...
    //   component: Services,
    //   label: 'Services',
    //   icon: <IoBriefcaseOutline size={30} color="white" />,
    //   // subs: [
    //   //   { path: '/default', label: 'menu.default', component: dashboards.default },
    //   //   { path: '/visual', label: 'menu.visual', component: dashboards.visual },
    //   //   { path: '/analytic', label: 'menu.analytic', component: dashboards.analytic },
    ...
    //   component: dashboards.visual,
    //   label: 'Financials',
    //   icon: <FaUserCog size={30} color="white" />,
    //   // subs: [
    //   //   { path: '/default', label: 'menu.default', component: dashboards.default },
    //   //   { path: '/visual', label: 'menu.visual', component: dashboards.visual },
    //   //   { path: '/analytic', label: 'menu.analytic', component: dashboards.analytic },
