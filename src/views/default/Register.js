...
const Register = () => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    confirmPassword: Yup.string().min(6, 'Must be at least 6 chars!').required('Confirm Password is required')
        .oneOf([Yup.ref('password')], 'Your passwords do not match.'),
    terms: Yup.bool().required().oneOf([true], 'Terms must be accepted'),
  });
  const initialValues = { firstName: '', lastName: '', phone: '', country: '', type: '', email: '', password: '', confirmPassword: '', terms: false };
  const onSubmit = async (values) => {
    setLoading(true)
    try {
      const profile  = await newProfile(values)
      console.log({profile})
      // eslint-disable-next-line no-underscore-dangle
      if (profile?.status === "success") {
        // eslint-disable-next-line no-underscore-dangle
        const user = await signUpUser({...values, profile: profile._id});
    ...
    <div className="sw-lg-70 min-h-100 bg-foreground d-flex justify-content-center align-items-center shadow-deep py-5 full-page-content-right-border">
      <div className="sw-lg-50 px-5">
        ...
        <div className="mb-3 text-center">
          <h2 className="cta-1 mb-0 text-primary">Create an Account</h2>
        </div>
        {/* <div className="mb-5"> */}
        ...
        <div>
          <form id="registerForm" className="tooltip-end-bottom" onSubmit={handleSubmit}>
            ...
            <div className="mb-3 filled form-group tooltip-end-top">
              <Form.Select aria-label="country select" name="country" style={{backgroundColor: '#f8f8f8', borderColor: '#f8f8f8'}} value={values.country} onChange={handleChange}>
            ...
            <div className="mb-3 filled form-group tooltip-end-top">
              <Form.Select aria-label="account type select" name="type" value={values.type} onChange={handleChange} style={{backgroundColor: '#f8f8f8', borderColor: '#f8f8f8'}}>
            ...
            <div className="mb-3 filled form-group tooltip-end-top">
              <CsLineIcons icon="user" />
              <Form.Control type="text" name="phone" placeholder="Phone Number" value={values.phone} onChange={handleChange} />
            ...
            <p className="h6 mt-5 text-center">
              If you are a member, please <NavLink to="/login">
              <span style={{textDecorationLine: 'underline', fontWeight: 700}}>login</span>
            </NavLink>.
            </p>
          </form>
        </div>
